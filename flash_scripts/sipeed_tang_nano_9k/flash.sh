...
yosys -D LEDS_NR=0 -p "read_verilog src/verilog/${HDL_PROJECT}/${HDL_DEVICE}/code.v; synth_gowin -json flash_scripts/sipeed_tang_nano_9k/artifacts/${HDL_PROJECT}_${HDL_DEVICE}.json"
